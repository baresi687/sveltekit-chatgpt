...
>
	<section>
		...
		<div bind:this={chatContainerRef}>
			<ChatGPT />
			<div class="absolute inset-0 max-w-5xl pointer-events-none my-0 mx-auto">
				<button
					on:click={() =>
					...
					} md:right-7 md:left-auto pointer-events-auto rounded-full h-11 w-11 mb-0.5 flex justify-center items-center border-2 border-slate-800 bg-slate-900 hover:brightness-125`}
					><svg

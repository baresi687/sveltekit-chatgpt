	...
	<div class="relative container mx-auto px-4 max-w-[800px] pb-24 mb-52">
		{#each chatResponses as chatResponse}
			{#if userMessageArray.length}
				<div
					class="whitespace-pre-line break-words rounded px-4 py-6 text-zinc-200 bg-skeletonDark"
				>
		...
		<div class="relative">
			{#if isError}
				<div class="absolute left-0 top-0 w-full">
					<div
						class="flex gap-4 items-center bg-red-900 whitespace-pre-line rounded mt-6 p-4 text-zinc-200"
					>
						<svg
